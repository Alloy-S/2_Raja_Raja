  ...
  options: {
    ...
    scales: {
      ...
      yAxes: [{
        ticks: {
          min: 0,
          max: 100, // Sesuaikan dengan jumlah maksimum orang yang ingin Anda tampilkan
          maxTicksLimit: 5,
          padding: 10,
          callback: function(value, index, values) {
            return number_format_people(value);
          }
        },
        gridLines: {
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel + ': ' + number_format_people(tooltipItem.yLabel);
        }
      }
    },
  }
